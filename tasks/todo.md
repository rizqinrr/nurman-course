...
- [x] 2026-09-16 NC-1.6 Test harness: Vitest + supertest, Prisma di-mock (fokus guard & validasi, bukan query) — selesai; commit implementasi `849d7bc` dipush ke `be-restruktur`, HEAD remote cocok. Dikerjakan sebelum NC-1.4, tanpa mengubah perilaku auth atau staging.
