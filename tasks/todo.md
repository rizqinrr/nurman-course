...
Ad-hoc:
- [x] 2026-08-24 UIUX: Redesign besar `/landing` dengan AppVerse.id Design System — warna utama tetap `#4a70a9` (biru), canvas `#f7f4ef` (warm bg), border `#c8b99a`, text `#1a1a18`, card/surface `#edeae3` (solid), rounded-[6px] buttons, rounded-2xl cards, font Playfair Display (heading) + DM Sans (body) via next/font/google di layout.tsx; build test 35 routes OK.
