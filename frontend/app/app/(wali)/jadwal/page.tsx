...
export default function JadwalSesiPage() {
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 max-w-4xl mx-auto w-full flex-grow flex flex-col gap-6 pb-8 animate-[fadeIn_0.5s_ease-out] font-dm text-app-text-mid">
      ...
      {selectedMurid ? (
        <>
          ...
          <section className="flex flex-col gap-4">
            <h3 className="text-lg font-bold text-gray-800 flex items-center gap-2 border-b border-app-border/40 pb-2">
            ...
            {upcomingSessions.length > 0 ? (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {upcomingSessions.map((session) => {
                  ...
                  return (
                    <div 
                      key={session.id} 
                      className="bg-app-white border border-app-border rounded-2xl p-6 shadow-md hover:shadow-lg transition-all duration-300 relative overflow-hidden flex flex-col justify-between gap-4"
                    >
                      ...
                      <Button
                        ...
                        className="w-full text-xs justify-center py-2.5 border border-[#4a70a9]/30 text-[#4a70a9] hover:bg-[#4a70a9]/5 flex items-center gap-1.5 mt-2 rounded-[6px]"
                      >
              ...
              <div className="text-center py-8 bg-app-white border border-app-border rounded-2xl text-gray-500 shadow-md">
              ...
              <div className="flex flex-col gap-4">
                {pastSessions.map((session) => {
                  ...
                  return (
                    <div 
                      key={session.id} 
                      className="bg-app-white border border-app-border rounded-2xl p-5 shadow-md flex flex-col md:flex-row gap-4 items-start md:items-center justify-between hover:shadow-lg transition-all duration-300"
                    >
                      ...
                      <Link href="/app/laporan" className="shrink-0 w-full md:w-auto">
                        <Button variant="ghost" className="w-full md:w-auto text-xs justify-center py-2 text-[#4a70a9] hover:bg-[#4a70a9]/5 flex items-center gap-1 rounded-[6px] border border-[#4a70a9]/30">
                          <FileText size={14} />
          ...
          <button
            ...
            className="fixed bottom-24 md:bottom-6 right-4 md:right-6 z-40 flex items-center gap-2 rounded-[6px] bg-[#4a70a9] text-white text-xs sm:text-sm font-semibold px-5 py-3.5 shadow-xl shadow-[#4a70a9]/30 hover:bg-[#3d5f96] active:scale-95 transition-all cursor-pointer border border-[#4a70a9]/50"
          >
